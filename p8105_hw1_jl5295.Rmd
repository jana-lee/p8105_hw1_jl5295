...
```
**Problem 1 Comment** Problem 1 asks us to take a deep dive into creating a dataframe. problem1_df was created and allows us to explore different types of vectors.
