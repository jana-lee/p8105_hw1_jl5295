...
The dataset has 500 rows and 5 columns. The mean of x is -0.0210897. The
median of x is -0.0068006. The standard deviation of x is 0.9664705. The
...
ggsave("plota.png", height = 4, width = 6)
  # Saved plota as a PNG file. Confirmed it is in the File Directory.
```
